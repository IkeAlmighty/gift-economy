...
export default function CreateContributionMenu({ onAction, intent, formData = {} }) {
  ...
  function handleFormSubmit(e) {
    ...
    newFormData.append("intent", intent); // 'Gift' or 'Request'
  ...
  return (
    <div>
      <h2 className="mb-5">Post a {intent === "GIFT" ? "Gift 🎁" : "Request 🪫"}</h2>
